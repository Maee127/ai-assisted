...
SAMPLE_COMMENTS = [
    ...
    {"username": "beauty_user22", "text": "Is this foundation suitable for oily skin?"},  # duplicate on purpose
    {"username": "denise_r", "text": "Does this work for sensitive skin? kind of unsure about it tbh"},
]
...
def simulate_ingestion():
    for i, c in enumerate(SAMPLE_COMMENTS):
        ...
        status = "inserted" if result["inserted"] else f"skipped ({result.get('reason')})"
